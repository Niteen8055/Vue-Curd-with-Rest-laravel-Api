...
export default {
    ...
    methods:{
        ...
        {
            var mythis = this;
            axios.get(`https://niteen.standardtouch.com/restApi/public/api/students/${id}/edit`).then(res =>{
                     console.log(res);
        ...
        updateStudent(){
            ...
            axios.put(`https://niteen.standardtouch.com/restApi/public/api/students/${this.studentId}/edit`,this.model.student).then(res =>{
